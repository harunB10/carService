...
<head>
  ...
  <script src="{{asset ('components/visibility.min.js') }}"></script>
  <script src="{{asset ('components/sidebar.min.js') }}"></script>
...
<div class="ui large top fixed hidden menu">
  <div class="ui container">
    <a class="active item">Početna</a>
    <a class="item">Usluge</a>
    <a class="item">O nama</a>
    <a class="item">Kontaktirajte nas</a>
    <div class="right menu">
      <div class="item">
        <a class="ui button">Prijava</a>
      </div>
      <div class="item">
        <a class="ui primary button">Registracija</a>
      </div>
    </div>
  </div>
</div>
...
<div class="pusher">
  <div class="ui inverted vertical masthead center aligned segment">
    ...
    <div class="ui text container">
      ...
      <h2>Online servis za praćenje servisa na Vašem vozilu.</h2>
      <div class="ui huge primary button">Registrujte se<i class="right arrow icon"></i></div>
    </div>
    ...
    <div class="ui middle aligned stackable grid container">
      <div class="row">
        ...
        <div class="six wide right floated column">
          <img src="{{ asset('/img/logo.jpg') }}" class="ui large bordered rounded image">
        </div>
      </div>
      <div class="row">
